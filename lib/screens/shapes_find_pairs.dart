...
class _ShapesFindPairsScreenState extends State<ShapesFindPairsScreen>
  ...
  Widget _buildTopBar(int pairsLeft) {
    return Container(
      ...
      child: Row(
        children: [
          KidBackButton(onTap: () => Navigator.pop(context), color: const Color(0xFF6C63FF)),
          SizedBox(width: 8.w),
          KidHomeButton(onTap: () => Navigator.of(context).popUntil((r) => r.isFirst)),
          SizedBox(width: 12.w),
          Text('Shape Pairs', style: GoogleFonts.fredoka(fontSize: 20.sp, fontWeight: FontWeight.bold, color: const Color(0xFF6C63FF))),
          const Spacer(),
          // Round progress
          Row(
